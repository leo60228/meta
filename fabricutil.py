...
variants = {
    ...
    "legacy-fabric": {
        ...
        "meta": "https://meta.legacyfabric.net/v2",
    ...
    "quilt": {
        "name": "Quilt Loader",
        "description": "Quilt Loader is a tool to load Quilt-compatible mods in game environments.",
        "url": "https://quiltmc.org",
        "authors": ["Quilt Developers"],
        "meta": "https://meta.quiltmc.org/v3",
        "maven": "https://maven.quiltmc.org/repository/release",
        "loader_uid": "org.quiltmc.quilt-loader",
        "intermediary_uid": "org.quiltmc.intermediary",
        "exclude": [],
    },
}
